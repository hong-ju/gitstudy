...
public class ExchangeCalc extends JFrame implements ActionListener{
	...
	public ExchangeCalc() {
		...
		getContentPane().add(pane1, "North");	//자리배치 (BorderLayout)
		getContentPane().add(pane2, "Center");	//자리배치 (BorderLayout)
	...
	public void calculate() {
		float won = Float.parseFloat(txt.getText());  // 입렫괸 문자를 신수로 변환
		String result = null;
